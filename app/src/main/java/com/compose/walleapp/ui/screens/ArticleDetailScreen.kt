...
import com.compose.walleapp.ui.components.WebView
import com.compose.walleapp.ui.components.rememberWebViewState
    ...
    BottomSheetScaffold(
        ...
        sheetContent = {
                       Column(modifier = Modifier.padding(8.dp)) {
                           ...
                           Slider(value = fontScale, onValueChange = {fontScale = it}, steps = 3, valueRange = 0.75f ..1.75f)
